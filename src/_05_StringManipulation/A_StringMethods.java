...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        int index = text.indexOf("o"); // int degýskene atanabilir. karýsýk o harfi
        ...
        /** lastIndexOf()
         *  String isinde aranan karakter(ler)in sondan itibaren ilk indexini verýr
    ...
    * bir stringe digerini ekler
     ...
     * */
        ...
        System.out.println(str4.toUpperCase()); //TECHPROEDUCATION
        ...
        System.out.println(str4);  //TECHPROEDUCATION
